...
export const PET_ITEMS = {
  ...
  PET_ITEM_BIG_TEETH_COMMON: {
    name: "Big Teeth",
    tier: "COMMON",
    description: `§7Increases §9 Crit Chance §7by §a5§7.`,
    stats: {
      crit_chance: 5,
    },
  },
  PET_ITEM_IRON_CLAWS_COMMON: {
    name: "Iron Claws",
    tier: "COMMON",
    description: `§7Increases the pet's §9$ Crit Damage §7by §a40% §7and §9 Crit Chance §7by §a40%§7.`,
    multStats: {
      crit_chance: 1.4,
      crit_damage: 1.4,
    },
  ...
  PET_ITEM_SHARPENED_CLAWS_UNCOMMON: {
    ...
    tier: "UNCOMMON",
    description: `§7Increases §9$ Crit Damage §7by §a15§7.`,
    stats: {
      crit_damage: 15,
    },
  },
  PET_ITEM_HARDENED_SCALES_UNCOMMON: {
    ...
    tier: "UNCOMMON",
    description: `§7Increases §a Defense §7by §a25§7.`,
    stats: {
      defense: 25,
    },
  },
  ...
  PET_ITEM_LUCKY_CLOVER: {
    name: "Lucky Clover",
    tier: "EPIC",
    description: `§7Increases §b Magic Find §7by §a7§7.`,
    stats: {
      magic_find: 7,
    },
  },
  PET_ITEM_TEXTBOOK: {
    name: "Textbook",
    tier: "LEGENDARY",
    description: `§7Increases the pet's §b Intelligence §7by §a100%§7.`,
    multStats: {
      intelligence: 2,
    },
  },
  ...
  REINFORCED_SCALES: {
    ...
    tier: "RARE",
    description: `§7Increases §a Defense §7by §a40§7.`,
    stats: {
      defense: 40,
    },
  },
  GOLD_CLAWS: {
    name: "Gold Claws",
    tier: "UNCOMMON",
    description: `§7Increases the pet's §9$ Crit Damage §7by §a50% §7and §9 Crit Chance §7by §a50%§7.`,
    multStats: {
      crit_chance: 1.5,
      crit_damage: 1.5,
    },
  ...
  BIGGER_TEETH: {
    name: "Bigger Teeth",
    tier: "UNCOMMON",
    description: `§7Increases §9 Crit Chance §7by §a10§7.`,
    stats: {
      crit_chance: 10,
    },
  },
  SERRATED_CLAWS: {
    name: "Serrated Claws",
    tier: "RARE",
    description: `§7Increases §9$ Crit Damage §7by §a25§7.`,
    stats: {
      crit_damage: 25,
    },
  },
  WASHED_UP_SOUVENIR: {
    ...
    tier: "LEGENDARY",
    description: `§7Increases §3 Sea Creature Chance §7by §a5§7.`,
    stats: {
  ...
  ANTIQUE_REMEDIES: {
    ...
    tier: "EPIC",
    description: `§7Increases the pet's §c Strength §7by §a80%§7.`,
    multStats: {
      strength: 1.8,
    },
  },
  CROCHET_TIGER_PLUSHIE: {
    ...
    tier: "EPIC",
    description: `§7Increases §e Bonus Attack Speed §7by §a35§7.`,
    stats: {
  ...
  PET_ITEM_SPOOKY_CUPCAKE: {
    name: "Spooky Cupcake",
    tier: "UNCOMMON",
    description: `§7Increases §c Strength §7by §a30 §7and §f Speed §7by §a20§7.`,
    stats: {
      strength: 30,
      speed: 20,
    },
  ...
  REAPER_GEM: {
    name: "Reaper Gem",
    tier: "LEGENDARY",
    description: `§7Gain §c8 Ferocity §7for §a5s §7on kill.`,
  },
  PET_ITEM_FLYING_PIG: {
    name: "Flying Pig",
    tier: "UNCOMMON",
  ...
  PET_ITEM_QUICK_CLAW: {
    name: "Quick Claw",
    tier: "RARE",
    description: `§7Every 2 pet level you gain §6+1  Mining Speed §7and §6+1 §6 Mining Fortune§7.`,
    statsPerLevel: {
      mining_speed: 0.5,
      mining_fortune: 0.5,
    },
  ...
  YELLOW_BANDANA: {
    name: "Yellow Bandana",
    tier: "RARE",
    description: `§7Grants §6+30  Farming Fortune§7.`,
    stats: {
      farming_fortune: 30,
    },
  },
  GREEN_BANDANA: {
    name: "Green Bandana",
    tier: "EPIC",
    description: `§7Grants §6+4  Farming Fortune§7 for each Garden Level unlocked.`,
